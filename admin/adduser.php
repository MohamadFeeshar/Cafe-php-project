...
<html lang="en">
  ...
  <div class="main">
    ...
    <input type="text" name="username" id="username" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
    <label for="email" class="fomrLable" style="font-size: 100%;">Email:</label>
    <input type="email" name="email" id="email" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
    <label for="password" class="fomrLable" style="font-size: 100%;">Password:</label>
    <input type="password" name="password" id="password" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
    <label for="confirmPass" class="fomrLable" style="font-size: 100%;">Confirm passowrd:</label>
    <input type="password" name="confirmpassword" id="confirmpassword" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
    <label for="RoomNo" class="fomrLable" style="font-size: 100%;">Room No.</label>
    <input type="text" name="roomno" id="roomno" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
    <label for="ext" class="fomrLable" style="font-size: 100%;">Ext</label>
    <input type="text" name="ext" id="ext" class="formInput" style="padding: 4px 4px;margin: 2px 0;" ><br>
